"""Run P05 preflight, E45 selector audit, one-GPU generation and finalization."""
...
SCRIPT = CODE / "scripts/run_final_private_p05_e46_kaggle.py"
CONFIG = CODE / "configs/final-private-p05-e46-top12v2-max1536-unified-v1.json"
INPUTS = ROOT / "inputs"
OUTPUT = ROOT / "output/final-private-p05-e46-top12v2-max1536-unified-v1"
FLAGS = [
...
def main() -> None:
    ...
    parser.add_argument("--model-cache", type=Path,
                        help="Pinned base-model snapshot directory; downloads exact revision if omitted")
    parser.add_argument("--gpu", default="0", help="Physical CUDA GPU index to expose (default: 0)")
    ...
    print(json.dumps({"status": "READY FOR MANUAL REVIEW", "questions": report["sample_size"],
